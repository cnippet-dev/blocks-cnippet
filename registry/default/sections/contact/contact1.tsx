        ...
        <div className="relative min-h-screen w-full px-4 py-16">
            <div className="mx-auto w-full max-w-xl">
                <div className="mb-8 flex justify-center">
                    <Badge
                        variant="outline"
                        className="flex items-center gap-2 border-none bg-white py-1 text-xs shadow-sm"
                    >
                ...
                <div className="mb-4 text-center">
                    <h1 className="font-funn text-4xl leading-tight font-medium text-gray-900 md:text-5xl">
