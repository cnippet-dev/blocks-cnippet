                ...
                <div className="grid items-center gap-12 lg:grid-cols-12 lg:gap-0">
                    <div className="col-span-7 flex h-full flex-col space-y-8">
                        <div className="space-y-6">
                            <h1 className="font-lite text-4xl font-normal text-gray-900 md:text-5xl lg:text-[5rem]">
                                Your mindset shapes{" "}
                            ...
                            <p className="font-kumb max-w-xl text-xl leading-relaxed text-gray-600">
                        ...
                        >
                            <Input
                                ...
                                className="h-12 border-gray-200 bg-white text-gray-600 shadow-none placeholder:text-base placeholder:text-gray-600"
                                required
                            />
                            <Button
                                type="submit"
                        ...
                        <div className="mt-auto flex flex-col items-start gap-4">
                            ...
                            <div className="flex items-center gap-2 text-gray-600">
                                <RiInfinityLine className="size-7 text-black" />
