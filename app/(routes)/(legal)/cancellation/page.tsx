                            ...
                            <div className="grid w-full grid-cols-12 border border-t-0 dark:border-neutral-800">
                                <div className="col-span-8 px-10 pt-10 pb-16">
                                    <p className="text-neutral-600 dark:text-neutral-400">
                                        ...
                                        through CNIPPET&apos;s platform. Please read
                                        this policy carefully before making any
                                        purchases.
                                    </p>
                                    ...
                                    <ul className="mt-2 list-disc pl-5 text-neutral-500 dark:text-neutral-400">
                                        ...
                                        <li>
                                            You retain access to premium
                                            features until your paid period ends
                                        </li>
                                        <li>
                                            No partial-month refunds are
                                            provided
                                        </li>
                                        <li>
                                    ...
                                    <ul className="mt-2 list-disc pl-5 text-neutral-500 dark:text-neutral-400">
                                        <li>
                                            ...
                                            to purchased content that we cannot
                                            resolve within 72 hours of your
                                            report
                                        </li>
                                        <li>
                                            <strong>Duplicate Charges:</strong>{" "}
                                            Accidental multiple charges for the
                                            same product
                                        </li>
                                        <li>
                                            <strong>
                                            ...
                                            When purchased templates or
                                            components fail to download due to
                                            system errors
                                        </li>
                                        <li>
                                    ...
                                    <ol className="mt-2 list-decimal pl-5 text-neutral-500 dark:text-neutral-400">
                                        ...
                                        <li>
                                            Include your transaction ID (found
                                            in your account or payment
                                            confirmation email)
                                        </li>
                                        <li>
                                    ...
                                    <ul className="mt-2 list-disc pl-5 text-neutral-500 dark:text-neutral-400">
                                        ...
                                        <li>
                                            Review and investigate within 7
                                            business days
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            ...
                                            business days to your original
                                            payment method
                                        </li>
                                    </ul>
                                    ...
                                    <ul className="mt-2 list-disc pl-5 text-neutral-500 dark:text-neutral-400">
                                        ...
                                        <li>
                                            ...
                                            Verified data breaches affecting
                                            your account
                                        </li>
                                        <li>
                                    ...
                                    <ul className="mt-2 list-disc pl-5 text-neutral-500 dark:text-neutral-400">
                                        ...
                                        <li>Blacklisting from future purchases across all CNIPPET platforms</li>
                                    ...
                                    <p className="pt-3 text-neutral-500 dark:text-neutral-400">
                                        ...
                                        billing issues before initiating a
                                        chargeback.
                                    </p>
                                    ...
                                    <ul className="mt-2 list-disc pl-5 text-neutral-500 dark:text-neutral-400">
                                        ...
                                        <li>
                                            Customizations and saved components
                                            will be restored
                                        </li>
                                        <li>
                                            Download history remains accessible
                                        </li>
                                        <li>
                                            After 6 months, accounts are
                                            permanently deleted
                                        </li>
                                    </ul>
