...
const Nav1 = () => {
    ...
    return (
        <>
            <header className="sticky top-0 z-50 mx-auto w-full max-w-full border-t-0 border-b bg-white/95 px-20 backdrop-blur-sm 2xl:px-30">
                <div className="w-full border border-t-0 border-b-0">
                        ...
                        <div className="col-span-9 px-4 py-3">
                            {mounted && (
                                ...
                                >
                                    ...
                                    <span className="hidden font-mono text-2xl lg:inline-block">
                                        Cnippet
                                    </span>
                                </Link>
                            )}
                        </div>
                        <div className="col-span-1 bg-black grid grid-cols-2 h-full divide-x divide-gray-500">
                            <Link
                                target="_blank"
                                rel="noreferrer"
                                className="hover:bg-accent w-full hover:text-accent-foreground focus-visible:ring-ring [&amp;_svg]:pointer-events-none [&amp;_svg]:size-5 [&amp;_svg]:shrink-0 inline-flex items-center justify-center gap-2 rounded-none px-0 text-sm font-medium whitespace-nowrap transition-colors focus-visible:ring-1 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50"
                            ...
                            {mounted && (
                                <div className="group/toggle focus-visible:ring-ring [&amp;_svg]:pointer-events-none [&amp;_svg]:size-5 [&amp;_svg]:shrink-0 inline-flex w-full items-center justify-center gap-2 rounded-md px-0 text-sm font-medium whitespace-nowrap transition-colors hover:bg-none focus-visible:ring-1 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50">
                                    {/* <Button
                                    variant="ghost"
                                    onClick={() => toggleTheme()}
                ...
                {/* <div className="absolute top-0 right-6 py-3">
