...
export default function Footer() {
    ...
    return (
        <>
            ...
            >
                <div className="relative -top-[100vh] h-[calc(100vh+550px)]">
                    <div className="sticky top-[calc(100vh-550px)] h-[550px]">
                        <footer className="sticky top-0 bg-white px-4 pt-28 pb-10 md:px-8 lg:px-16 dark:bg-black dark:text-white">
