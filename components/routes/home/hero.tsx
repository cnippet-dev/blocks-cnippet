...
//                         <div className="grid h-12 grid-cols-1 md:grid-cols-4 divide-x border-t xl:grid-cols-6 dark:divide-neutral-800 dark:border-neutral-800">
...
//                         <div className="grid h-32 grid-cols-4 divide-x border-t md:h-40 md:grid-cols-4 xl:grid-cols-6 dark:divide-neutral-800 dark:border-neutral-800">
...
const Hero = forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
    (props, ref) => {
        return (
            ...
            //     <section className="font-kumb mx-auto w-full max-w-full border-t-0 border-b px-4 md:px-10 xl:px-20 2xl:px-30 dark:border-neutral-800 dark:bg-black">
            //         <div className="border border-t-0 border-b-0 dark:border-neutral-800">
            //             <div className="grid grid-cols-1 divide-y md:grid-cols-6 md:divide-x md:divide-y-0 dark:divide-neutral-800">
            //                 <div className="col-span-1 space-y-5 px-4 py-10 md:col-span-4 md:py-20">
            //                     <p className="text-sm tracking-wide text-gray-700 uppercase">
            //                         Advanced UI components and templates
            //                     </p>
            //                     <h1 className="mt-2 text-5xl tracking-tighter text-pretty sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl">
            //                         Build your next{" "}
            //                         <span className="text-violet-600">
            //                             idea
            //                         </span>{" "}
            ...
            //                     </h1>
            //                 </div>
            //                 <div className="col-span-1 flex items-start px-4 pt-0 md:col-span-2 md:items-end md:pt-0 md:pb-10 lg:pb-20">
            //                     <p className="max-w-full py-12 text-base text-gray-700 md:py-0 md:text-lg">
            //                         Beautifully designed, expertly crafted
            //                         components and templates, built by the
            //                         makers of Tailwind CSS. The perfect starting
            //                         point for your next project.
            ...
            //             <div className="grid h-auto grid-cols-1 divide-x divide-y border-t sm:grid-cols-2 sm:divide-y-0 md:grid-cols-4 lg:grid-cols-6 dark:divide-neutral-800 dark:border-neutral-800">
            ...
            //                 <div
            //                     ref={ref}
            //                     className="col-span-1 flex h-12 w-full"
            //                 >
            //                     <Link
            //                         href="#explore"
            //                         className="group relative flex h-full w-full items-center justify-center overflow-hidden bg-black"
            ...
            //                 <Link
            //                     href="#explore"
            //                     className="group relative col-span-1 flex h-12 w-full items-center justify-center overflow-hidden bg-white"
            //                 >
            //                     <div className="absolute inset-0 w-full -translate-x-[110%] bg-gray-200 transition-transform duration-300 group-hover:translate-x-[0%] dark:bg-blue-600" />
            //                     <span className="relative z-10 flex w-full items-center justify-between gap-2 px-4 text-lg text-black duration-300 dark:text-white">
            //                         Browse templates
            ...
            //             {/* Spacer Row */}
            //             <div className="grid h-24 grid-cols-1 divide-x border-t md:h-40 md:grid-cols-4 lg:grid-cols-6 dark:divide-neutral-800 dark:border-neutral-800">
            //                 <div className="col-span-1"></div>
            //                 <div className="col-span-1"></div>
            //                 <div className="col-span-1"></div>
            //                 <div className="col-span-1"></div>
            ...
            //             <div className="grid grid-cols-1 divide-y border-t md:grid-cols-2 md:divide-x md:divide-y-0 lg:grid-cols-3 dark:divide-neutral-800 dark:border-neutral-800">
            //                 <div className="group col-span-1 flex flex-col items-start justify-start gap-4 px-4 py-10 sm:flex-row">
            //                     <svg
            //                         className="w-28 shrink-0 text-black *:data-lift:transition-transform *:data-lift:duration-300 group-hover:*:data-lift:-translate-y-0.5 group-data-selected:*:data-lift:translate-y-0 sm:w-30"
            //                         aria-hidden="true"
            //                         fill="none"
            //                         viewBox="0 0 120 72"
            //                     >
            ...
            //                     </div>
            //                 </div>
            //                 <div className="group dark:bg-background col-span-1 flex flex-col items-start justify-start gap-4 bg-indigo-50/80 px-4 py-10 sm:flex-row">
            //                     <svg
            //                         className="w-28 shrink-0 text-indigo-700 *:data-lift:transition-transform *:data-lift:duration-300 group-hover:*:data-lift:-translate-y-0.5 group-data-selected:*:data-lift:translate-y-0 sm:w-30"
            //                         aria-hidden="true"
            //                         fill="none"
            //                         viewBox="0 0 120 72"
            //                     >
