                ...
                <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
                    <div className="flex flex-col items-start text-left">
                        ...
                        <p className="text-sm text-gray-600">
                            Fully styled components using modern utility-first
                    ...
                    <div className="flex flex-col items-center text-center">
                        ...
                        <p className="text-sm text-gray-600">
                            Over 100 UI blocks and components designed for
                    ...
                    <div className="flex flex-col items-center text-center">
                        ...
                        <p className="text-sm text-gray-600">
                            A full set of data visualization blocks for creating
                    ...
                    <div className="flex flex-col items-center text-center">
                        ...
                        <p className="text-sm text-gray-600">
                            All of our blocks come with both light and dark mode
                            variants for perfect visual experience
                        </p>
                    </div>
                </div>
            </div>
